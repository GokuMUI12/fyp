...
try:
    ...
    # st.markdown(f"## ✅ TensorFlow is installed (Version: {tf_version})")
    
    # Check if GPU is available
  
except ImportError:
    st.markdown("## ❌ TensorFlow is not installed")
...
with st.expander("Now you can predict faults"):
    ...
    if inference_submit:
        ...
        loaded_model = load_model("model/final-weights.keras", custom_objects={'cross_entropy_balanced': cross_entropy_balanced})
